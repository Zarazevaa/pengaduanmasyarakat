...
<div class="card shadow">
    ...
    <a href="?url=lihat_pengaduan" class="btn btn-dark btn-icon-split">
    ...
    <div class="card-body">
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            $sql=mysqli_query($conn,"select * from pengaduan, tanggapan where tanggapan.id_pengaduan='$_GET[id]' and
            tanggapan.id_pengaduan=pengaduan.id_pengaduan");
            $cek=mysqli_num_rows($sql);
                if ($cek<1) //jika tidak ditemukan
                    {
                        echo "<font color='red'>Harap bersabar, pengaduan anda belum ditanggapi</font>";
                    } else {
