              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user" placeholder="Nomor Telepon">
                    </div>

                    <div class="form-group">

                    </div>
                    <input type="submit" class="btn btn-dark btn-user btn-block" value="Register">
