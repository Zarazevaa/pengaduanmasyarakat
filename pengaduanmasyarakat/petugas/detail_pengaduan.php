...
<div class="card shadow">
    ...
    <a href="?url=verifikasi_pengaduan" class="btn btn-danger btn-icon-split">
    ...
    <a href="proses.php?id=<?php echo $data['id_pengaduan']; ?>" class="btn btn-dark btn-icon-split" onclick="return confirm('apakah anda yakin akan diproses?')">
        <span class="icon text-white-50">
